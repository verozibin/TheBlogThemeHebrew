...
namespace OrchardCore.Themes.TheBlogThemeHebrew
{
    public class ResourceManifest : IResourceManifestProvider
    {
        public void BuildManifests(IResourceManifestBuilder builder)
        {
            ...
            manifest
                .DefineScript("TheBlogThemeHebrew-vendor-jQuery")
                .SetUrl("~/TheBlogThemeHebrew/vendor/jquery/jquery.min.js", "~/TheBlogThemeHebrew/vendor/jquery/jquery.js")
            ...
            manifest
                .DefineScript("TheBlogThemeHebrew-vendor-jQuery.slim")
                .SetUrl("~/TheBlogThemeHebrew/vendor/jquery/jquery.slim.min.js", "~/TheBlogThemeHebrew/vendor/jquery/jquery.slim.js")
            ...
            manifest
                .DefineScript("TheBlogThemeHebrew-vendor-bootstrap")
                .SetDependencies("TheBlogThemeHebrew-vendor-jQuery")
                .SetUrl("~/TheBlogThemeHebrew/vendor/bootstrap/js/bootstrap.min.js", "~/TheBlogThemeHebrew/vendor/bootstrap/js/bootstrap.js")
            ...
            manifest
                .DefineScript("TheBlogThemeHebrew-vendor-bootstrap-bundle")
                .SetDependencies("TheBlogThemeHebrew-vendor-jQuery")
                .SetUrl("~/TheBlogThemeHebrew/vendor/bootstrap/js/bootstrap.bundle.min.js", "~/TheBlogThemeHebrew/vendor/bootstrap/js/bootstrap.bundle.js")
            ...
            manifest
                .DefineStyle("TheBlogThemeHebrew-vendor-bootstrap")
                .SetUrl("~/TheBlogThemeHebrew/vendor/bootstrap/css/bootstrap.min.css", "~/TheBlogThemeHebrew/vendor/bootstrap/css/bootstrap.css")
            ...
            manifest
                .DefineStyle("TheBlogThemeHebrew-bootstrap-oc")
                .SetUrl("~/TheBlogThemeHebrew/css/bootstrap-oc.min.css", "~/TheBlogThemeHebrew/css/bootstrap-oc.css")
                .SetVersion("1.0.0");
				
            manifest
                .DefineStyle("TheBlogThemeHebrew-vendor-font-awesome")
                .SetUrl("~/TheBlogThemeHebrew/vendor/fontawesome-free/css/all.min.css", "~/TheBlogThemeHebrew/vendor/fontawesome-free/css/all.css")
            ...
            manifest
                .DefineScript("TheBlogThemeHebrew-vendor-font-awesome")
